<div>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-login:hover { background: #16a34a; color: white; }
        .btn-register {
            text-decoration: none;
            padding: 8px 20px;
            border-radius: 8px;
        ...
        .btn-register:hover { background: #15803d; box-shadow: 0 4px 12px rgba(22,163,74,0.3); }
        .btn-dashboard {
            text-decoration: none;
            padding: 8px 20px;
            border-radius: 8px;
            ...
            <div class="berita-grid">
                @foreach($this->relatedArticles as $related)
                    <article class="berita-card animate-fade-up">
                        <a href="{{ route('berita.detail', $related->slug) }}" style="text-decoration:none;color:inherit;">
                            @if($related->image)
                        ...
                        <div class="berita-footer">
                            ...
                            <a href="{{ route('berita.detail', $related->slug) }}" class="berita-readmore">
                                Baca Selengkapnya
